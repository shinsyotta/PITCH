...
// Implements ERC-223 / ERC-20 standards
...
contract ERC223Token is SafeMath {
  ...
  string public symbol  = "PITCH";
  uint8 public decimals = 9;
  uint256 public totalSupply;
  address initialHolder = 0xdc8fE10C5e872e25Ac24dE310e60D88E4b7a22a1; // TODO: Change prior to deployment
  
  function ERC223Token()
  {
      balances[initialHolder] = 1618000000 * (10 ** decimals);
      totalSupply = balances[initialHolder];
  }
